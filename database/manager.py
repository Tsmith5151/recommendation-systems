"""Helper class for managing connections to backend store for \
serving a Flask web app to enable fetching rankings; this can \
be extended for specific use-cases but provides a proxy for \
getting started. \
"""
...
import yaml
import sqlite3
from recommenders.utils.logger import get_logger
