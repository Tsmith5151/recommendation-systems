"""Helper functions for creating backend store for serving a Flask \
web app to enable fetching rankings; this can be extended for \
specific use-cases but provides a proxy for getting started. \
"""
import os
import pandas as pd
